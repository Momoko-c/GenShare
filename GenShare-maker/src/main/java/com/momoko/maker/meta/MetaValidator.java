...
import com.momoko.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "momoko");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.momoko");
